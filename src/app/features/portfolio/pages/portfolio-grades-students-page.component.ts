...
@Component({
  selector: 'tj-portfolio-grades-students-page',
  standalone: true,
...
export class PortfolioGradesStudentsPageComponent {
  ...
  constructor() {
    effect(() => {
      const pageMeta = this.content.getPageMeta(
        'portfolio-grados-estudiantes',
        'TECNOJACK | Grados para estudiantes',
        'Paquetes para fotografía de grado, promociones y ceremonias con entregas claras.'
      );
